...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
template <class T> struct HorthogCopyBlock_Functor
{
    T *E, *TE;
    T **ptr_E, **ptr_TE;
    ...
    HorthogCopyBlock_Functor(T *E, T *TE, T **ptr_E, T **ptr_TE, int child_new_rank, int parent_rank,
...
inline void horthog_copyBlock_marshal_batch(T *E, T *TE, T **ptr_E, T **ptr_TE, int child_new_rank, int parent_rank,
...
{
    HorthogCopyBlock_Functor<T> copyblock_functor(E, TE, ptr_E, ptr_TE, child_new_rank, parent_rank, parent_new_rank,
