...
#define H2OPUS_DIST_HORTHOG_GATHER_EVENT 0
#define H2OPUS_DIST_HORTHOG_TOTAL_EVENTS 1

///////////////////////////////////////////////////////////////////////////////////
// Helper structs
///////////////////////////////////////////////////////////////////////////////////
template <int hw> struct HorthogLowRankExchangeHelper
{
    TDistributedCompressedBSNData<hw> *bsn_data;
    TDistributedSendRecvBuffer<hw> *comm_buffer;
    int rows, cols;

    HorthogLowRankExchangeHelper(){};

    void init(TDistributedCompressedBSNData<hw> *bsn_data, TDistributedSendRecvBuffer<hw> *comm_buffer, int rows,
              int cols)
    {
...
// Handling requests
///////////////////////////////////////////////////////////////////////////////////
template <int hw> inline void horthogExecuteLowRankExchange(HorthogLowRankExchangeHelper<hw> *exchange_helper)
{
...
template <int hw> inline void horthogExecuteLowRankWait(HorthogLowRankExchangeHelper<hw> *exchange_helper)
{
    TDistributedSendRecvBuffer<hw> *comm_buffer = exchange_helper->comm_buffer;
...
template <int hw>
inline void horthogExecuteBlockingLowRankExchange(
    std::vector<HorthogLowRankExchangeHelper<hw>> &low_rank_exchange_helpers, H2OpusEvents &events, int local_rank,
